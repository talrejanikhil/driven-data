...
train_values[['thal']] = train_values[['thal']].apply(categorize_label, axis=0)
...
test_values_subset[['thal']] = test_values_subset[['thal']].apply(categorize_label, axis=0)
test_values_subset = pd.get_dummies(test_values_subset, drop_first=True)
cv.fit(X, y)
